-- Originally written by appgurueu
-- Modified by me for Primso based on some data and analytics available
--
local PLAYERS_MSG = {}
local PLAYERS_FREQ = {}
local SPAM_SPEED = 4 
...
minetest.register_on_chat_message(function(name, message)
	...
	if PLAYERS_MSG[name][message] then
		...
		if amount >= SPAM_KICK then minetest.kick_player(name, "Kicked for spamming.")
            minetest.chat_send_all(minetest.colorize("#00ff00","<prismo> "..name.." has been kicked for spamming."))
